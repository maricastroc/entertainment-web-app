...
import handler from '@/pages/api/tv/popular/[id].api'
...
describe('GET /api/tv/popular/[id]', () => {
  it('should return popular tv shows with correct structure', async () => {
    ...
    expect(getUrl2).toHaveBeenCalledWith('tv/popular', '1')
