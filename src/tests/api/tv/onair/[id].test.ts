...
import handler from '@/pages/api/tv/onair/[id].api'
...
describe('GET /api/tv/airing/[id]', () => {
  it('should return on air tv shows with correct structure', async () => {
    ...
    expect(getUrl2).toHaveBeenCalledWith('tv/on_the_air', '1')
